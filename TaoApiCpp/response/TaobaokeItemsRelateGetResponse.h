#ifndef TAOBAOKEITEMSRELATEGETRESPONSE_H
#define TAOBAOKEITEMSRELATEGETRESPONSE_H
...
/**
 * @brief TOP RESPONSE API: 商品关联推荐。注意：pid、nick为非必选参数，未来pid、nick入参将取消，程序会自动根据appkey对应的nick去查询pid。pid、nick入参将兼容支持到10月31日，请ISV做好改造工作，不要传入pid或nick。 
 ...
 */
class TaobaokeItemsRelateGetResponse : public TaoResponse
{
public:
 virtual ~TaobaokeItemsRelateGetResponse() { }
