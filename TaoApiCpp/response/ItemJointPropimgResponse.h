#ifndef ITEMJOINTPROPIMGRESPONSE_H
#define ITEMJOINTPROPIMGRESPONSE_H
...
/**
 * @brief TOP RESPONSE API: * 关联一张商品属性图片到num_iid指定的商品中 
 ...
 */
class ItemJointPropimgResponse : public TaoResponse
{
public:
 virtual ~ItemJointPropimgResponse() { }
