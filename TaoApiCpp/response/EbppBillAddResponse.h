#ifndef EBPPBILLADDRESPONSE_H
#define EBPPBILLADDRESPONSE_H

#include <TaoApiCpp/TaoResponse.h>


/**
 * @brief TOP RESPONSE API: 创建生活账单
 * 
 * @author sd44 <sd44sdd44@yeah.net>
 */
class EbppBillAddResponse : public TaoResponse
{
public:
 virtual ~EbppBillAddResponse() { }
