#ifndef SIMBARPTCAMPADGROUPEFFECTGETREQUEST_H
#define SIMBARPTCAMPADGROUPEFFECTGETREQUEST_H
...
/**
 * TOP API: 推广计划下的推广组报表效果数据查询(只有汇总数据，无分类类型)
 * 
 * @author sd44 <sd44sdd44@yeah.net>
 */
class SimbaRptCampadgroupeffectGetRequest : public TaoRequest
{
 public:
...
;  void setSubwayToken (QString subwayToken);
  ...
  virtual SimbaRptCampadgroupeffectGetResponse *getResponseClass(const QString &session = "",
...
#endif  /* SIMBARPTCAMPADGROUPEFFECTGETREQUEST_H */
