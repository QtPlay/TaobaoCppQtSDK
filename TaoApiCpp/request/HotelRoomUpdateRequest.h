#ifndef HOTELROOMUPDATEREQUEST_H
#define HOTELROOMUPDATEREQUEST_H
...
/**
 * TOP API: 此接口用于更新一个集市酒店商品，根据传入的gid更新商品信息，该商品必须为对应的发布者才能执行更新操作。如果对应的商品在淘宝集市酒店系统中不存在，则会返回错误提示。
 * 
 * @author sd44 <sd44sdd44@yeah.net>
 */
class HotelRoomUpdateRequest : public TaoRequest
{
 public:
...
;  void setTitle (QString title);
  ...
  virtual HotelRoomUpdateResponse *getResponseClass(const QString &session = "",
...
/**
 * @brief 酒店商品图片。类型:JPG,GIF;最大长度:500K。支持的文件类型：gif,jpg,jpeg,png。更新的时候只能更新一张图片，此图片覆盖原有所有图片。如果不传则使用原有所有图片。 
...
/**
 * @brief 状态。可选值1，2，3。1：上架。2：下架。3：删除。传入相应状态代表去执行相应的操作。
 **/
  qlonglong status;
...
#endif  /* HOTELROOMUPDATEREQUEST_H */
