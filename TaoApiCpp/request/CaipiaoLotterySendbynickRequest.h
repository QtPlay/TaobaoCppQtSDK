#ifndef CAIPIAOLOTTERYSENDBYNICKREQUEST_H
#define CAIPIAOLOTTERYSENDBYNICKREQUEST_H
...
/**
 * TOP API: 卖家使用nick给买家送彩票，可以指定彩种和注数。赠送成功，返回true; 以下几种情况情况， 返回false: 注数超过100注、卖家未签署支付宝代扣协议、卖家或者买家信息不存在等。
 * 
 * @author sd44 <sd44sdd44@yeah.net>
 */
class CaipiaoLotterySendbynickRequest : public TaoRequest
{
 public:
...
;  void setSweetyWords (QString sweetyWords);
  ...
  virtual CaipiaoLotterySendbynickResponse *getResponseClass(const QString &session = "",
                               const QString &accessToken = ""); 

 private:
/**
 * @brief 彩票接收方nick， 不可为空、""。
 **/
  QString buyerNick;
...
#endif  /* CAIPIAOLOTTERYSENDBYNICKREQUEST_H */
