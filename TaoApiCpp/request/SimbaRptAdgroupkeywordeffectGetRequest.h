#ifndef SIMBARPTADGROUPKEYWORDEFFECTGETREQUEST_H
#define SIMBARPTADGROUPKEYWORDEFFECTGETREQUEST_H
...
/**
 * TOP API: 推广组下的词效果报表数据查询(明细数据不分类型查询)
 * 
 * @author sd44 <sd44sdd44@yeah.net>
 */
class SimbaRptAdgroupkeywordeffectGetRequest : public TaoRequest
{
 public:
...
;  void setSubwayToken (QString subwayToken);
  ...
  virtual SimbaRptAdgroupkeywordeffectGetResponse *getResponseClass(const QString &session = "",
...
#endif  /* SIMBARPTADGROUPKEYWORDEFFECTGETREQUEST_H */
