#ifndef HOTELORDERBOOKINGFEEDBACKREQUEST_H
#define HOTELORDERBOOKINGFEEDBACKREQUEST_H
 ...
 */
class HotelOrderBookingFeedbackRequest : public TaoRequest
{
 public:
...
;  void setOutOid (QString outOid);
 ...
 QString getRefundCode() const
;  void setRefundCode (QString refundCode);
...
;  void setSessionId (qlonglong sessionId);
  ...
  virtual HotelOrderBookingFeedbackResponse *getResponseClass(const QString &session = "",
...
/**
 * @brief 在合作方退订时可能要用到的标识码，最长250个字符
 **/
  QString refundCode;
...
#endif  /* HOTELORDERBOOKINGFEEDBACKREQUEST_H */
