#ifndef SIMBARPTADGROUPBASEGETREQUEST_H
#define SIMBARPTADGROUPBASEGETREQUEST_H
 ...
 */
class SimbaRptAdgroupbaseGetRequest : public TaoRequest
{
 public:
...
;  void setSubwayToken (QString subwayToken);
  ...
  virtual SimbaRptAdgroupbaseGetResponse *getResponseClass(const QString &session = "",
...
#endif  /* SIMBARPTADGROUPBASEGETREQUEST_H */
