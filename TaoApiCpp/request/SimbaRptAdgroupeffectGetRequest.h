#ifndef SIMBARPTADGROUPEFFECTGETREQUEST_H
#define SIMBARPTADGROUPEFFECTGETREQUEST_H
 ...
 */
class SimbaRptAdgroupeffectGetRequest : public TaoRequest
{
 public:
...
;  void setSubwayToken (QString subwayToken);
  ...
  virtual SimbaRptAdgroupeffectGetResponse *getResponseClass(const QString &session = "",
...
#endif  /* SIMBARPTADGROUPEFFECTGETREQUEST_H */
