#ifndef DELIVERYTEMPLATESGETREQUEST_H
#define DELIVERYTEMPLATESGETREQUEST_H
...
/**
 * TOP API: 根据用户ID获取用户下所有模板
 * 
 * @author sd44 <sd44sdd44@yeah.net>
 */
class DeliveryTemplatesGetRequest : public TaoRequest
{
 public:
...
;  void setFields (QString fields);
  ...
  virtual DeliveryTemplatesGetResponse *getResponseClass(const QString &session = "",
...
#endif  /* DELIVERYTEMPLATESGETREQUEST_H */
