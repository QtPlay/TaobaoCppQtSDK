#ifndef SIMBARPTCAMPAIGNEFFECTGETREQUEST_H
#define SIMBARPTCAMPAIGNEFFECTGETREQUEST_H
...
/**
 * TOP API: 推广计划效果报表数据对象
 * 
 * @author sd44 <sd44sdd44@yeah.net>
 */
class SimbaRptCampaigneffectGetRequest : public TaoRequest
{
 public:
...
;  void setSubwayToken (QString subwayToken);
  ...
  virtual SimbaRptCampaigneffectGetResponse *getResponseClass(const QString &session = "",
...
#endif  /* SIMBARPTCAMPAIGNEFFECTGETREQUEST_H */
