#ifndef SIMBARPTADGROUPNONSEARCHBASEGETREQUEST_H
#define SIMBARPTADGROUPNONSEARCHBASEGETREQUEST_H
...
/**
 * TOP API: 推广组下的定向推广基础数据查询
 * 
 * @author sd44 <sd44sdd44@yeah.net>
 */
class SimbaRptAdgroupnonsearchbaseGetRequest : public TaoRequest
{
 public:
...
;  void setSubwayToken (QString subwayToken);
  ...
  virtual SimbaRptAdgroupnonsearchbaseGetResponse *getResponseClass(const QString &session = "",
...
#endif  /* SIMBARPTADGROUPNONSEARCHBASEGETREQUEST_H */
