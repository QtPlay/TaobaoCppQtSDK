#ifndef LOGISTICSORDERSDETAILGETREQUEST_H
#define LOGISTICSORDERSDETAILGETREQUEST_H
...
/**
 * TOP API: 查询物流订单的详细信息，涉及用户隐私字段。（注：该API主要是提供给卖家查询物流订单使用，买家查询物流订单，建议使用taobao.logistics.trace.search）
 * 
 * @author sd44 <sd44sdd44@yeah.net>
 */
class LogisticsOrdersDetailGetRequest : public TaoRequest
{
 public:
...
;  void setType (QString type);
  ...
  virtual LogisticsOrdersDetailGetResponse *getResponseClass(const QString &session = "",
...
/**
 * @brief 创建时间结束.格式:yyyy-MM-dd HH:mm:ss
 **/
  QDateTime endCreated;

/**
 * @brief 需返回的字段列表.可选值:Shipping 物流数据结构中所有字段.fileds中可以指定返回以上任意一个或者多个字段,以","分隔.
 **/
  QString fields;
...
/**
 * @brief 创建时间开始.格式:yyyy-MM-dd HH:mm:ss
 **/
  QDateTime startCreated;

/**
 * @brief 物流状态.可查看数据结构 Shipping 中的status字段.
 **/
  QString status;
...
#endif  /* LOGISTICSORDERSDETAILGETREQUEST_H */
