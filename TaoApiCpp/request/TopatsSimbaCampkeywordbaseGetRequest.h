#ifndef TOPATSSIMBACAMPKEYWORDBASEGETREQUEST_H
#define TOPATSSIMBACAMPKEYWORDBASEGETREQUEST_H
...
/**
 * TOP API: 直通车推广计划下的词报表基础数据查询<br/> 
异步API使用方法，请查看：<a href="http://open.taobao.com/doc/detail.htm?id=30">异步API使用说明</a><br/>
 * 
 * @author sd44 <sd44sdd44@yeah.net>
 */
class TopatsSimbaCampkeywordbaseGetRequest : public TaoRequest
{
 public:
...
;  void setTimeSlot (QString timeSlot);
  ...
  virtual TopatsSimbaCampkeywordbaseGetResponse *getResponseClass(const QString &session = "",
...
#endif  /* TOPATSSIMBACAMPKEYWORDBASEGETREQUEST_H */
