#ifndef ITEMSKUPRICEUPDATEREQUEST_H
#define ITEMSKUPRICEUPDATEREQUEST_H
 ...
 */
class ItemSkuPriceUpdateRequest : public TaoRequest
{
 public:
...
;  void setQuantity (qlonglong quantity);
  ...
  virtual ItemSkuPriceUpdateResponse *getResponseClass(const QString &session = "",
...
#endif  /* ITEMSKUPRICEUPDATEREQUEST_H */
