#ifndef SIMBARPTDEMOGRAPHICEFFECTGETREQUEST_H
#define SIMBARPTDEMOGRAPHICEFFECTGETREQUEST_H
...
/**
 * TOP API: 推广计划下的人群维度效果数据查询
 * 
 * @author sd44 <sd44sdd44@yeah.net>
 */
class SimbaRptDemographiceffectGetRequest : public TaoRequest
{
 public:
...
;  void setSubwayToken (QString subwayToken);
  ...
  virtual SimbaRptDemographiceffectGetResponse *getResponseClass(const QString &session = "",
...
#endif  /* SIMBARPTDEMOGRAPHICEFFECTGETREQUEST_H */
