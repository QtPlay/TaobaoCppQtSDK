#ifndef WANGWANGESERVICERECEIVENUMGETREQUEST_H
#define WANGWANGESERVICERECEIVENUMGETREQUEST_H
...
/**
 * TOP API: 根据操作者ID，返回被查者ID指定时间段内每个帐号的"已接待人数"<br/> 
备注：<br/> 
 ...
 */
class WangwangEserviceReceivenumGetRequest : public TaoRequest
{
 public:
...
;  void setStartDate (QDateTime startDate);
  ...
  virtual WangwangEserviceReceivenumGetResponse *getResponseClass(const QString &session = "",
                               const QString &accessToken = ""); 

 private:
/**
 * @brief 查询接待人数的结束日期 时间精确到日 时分秒可以直接传00:00:00
 **/
  QDateTime endDate;
...
/**
 * @brief 查询接待人数的开始日期 时间精确到日 时分秒可直接传 00:00:00
 **/
  QDateTime startDate;

};

#endif  /* WANGWANGESERVICERECEIVENUMGETREQUEST_H */
