#ifndef LOGISTICSADDRESSMODIFYREQUEST_H
#define LOGISTICSADDRESSMODIFYREQUEST_H
 ...
 */
class LogisticsAddressModifyRequest : public TaoRequest
{
 public:
...
;  void setZipCode (QString zipCode);
  ...
  virtual LogisticsAddressModifyResponse *getResponseClass(const QString &session = "",
...
/**
 * @brief 手机号码，手机与电话必需有一个 <br><font color='red'>手机号码不能超过20位</font>
 **/
  QString mobilePhone;
...
#endif  /* LOGISTICSADDRESSMODIFYREQUEST_H */
