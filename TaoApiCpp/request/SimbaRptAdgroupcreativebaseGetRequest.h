#ifndef SIMBARPTADGROUPCREATIVEBASEGETREQUEST_H
#define SIMBARPTADGROUPCREATIVEBASEGETREQUEST_H
...
/**
 * TOP API: 推广组下创意报表基础数据查询(汇总数据，不分类型)
 * 
 * @author sd44 <sd44sdd44@yeah.net>
 */
class SimbaRptAdgroupcreativebaseGetRequest : public TaoRequest
{
 public:
...
;  void setSubwayToken (QString subwayToken);
  ...
  virtual SimbaRptAdgroupcreativebaseGetResponse *getResponseClass(const QString &session = "",
...
#endif  /* SIMBARPTADGROUPCREATIVEBASEGETREQUEST_H */
